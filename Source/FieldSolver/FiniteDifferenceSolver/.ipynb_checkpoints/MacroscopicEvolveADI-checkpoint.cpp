...
namespace
{
    ...
    void add_soft_e_source_to_rhs (
        ...
        Periodicity const& periodicity, int half_step)
    {
        if (WarpX::E_excitation_grid_s != "parse_e_excitation_grid_function") {
            return;
        }

        int const scheme = WarpX::adi_e_excitation;
        Real time_frac = 0.5_rt;
        Real weight = 1._rt;
        bool active = false;
        if (scheme == AdiEExcitation::A) {
            // First half only: S^{n+1/2}
            active = (half_step == 1);
        } else if (scheme == AdiEExcitation::B) {
            // Second half only: S^{n+1/2}
            active = (half_step == 2);
        } else if (scheme == AdiEExcitation::C) {
            // Both halves: (1/2) S^{n+1/2}
            active = true;
            weight = 0.5_rt;
        } else if (scheme == AdiEExcitation::D) {
            // Both halves: (1/2) S^{n+1/4} then (1/2) S^{n+3/4}
            active = true;
            weight = 0.5_rt;
        ...
        MultiFab cb_field = make_rhs(rhs);
        copy_coeff_to_layout(cb_field, Cb, periodicity);
...
#pragma omp parallel if (Gpu::notInLaunchRegion())
        ...
        for (MFIter mfi(rhs, TilingIfNotGPU()); mfi.isValid(); ++mfi) {
            ...
            Array4<Real const> const cb_arr = cb_field.const_array(mfi);
            ...
            ParallelFor(bx, [=] AMREX_GPU_DEVICE (int i, int j, int k) noexcept
            {
                ...
                if (flag_type > 2._rt) {
                    ...
                    amrex::Abort(
                        "Macroscopic ADI does not support hard electric sources.");
                }
            });
        }
    }
        ...
        Periodicity const& periodicity)
    {
        ...
        add_soft_e_source_to_rhs(rhs, *mat.Cb[0], 0, periodicity, 1);
        return rhs;
    }
        ...
        Periodicity const& periodicity)
    {
        ...
        add_soft_e_source_to_rhs(rhs, *mat.Cb[1], 1, periodicity, 1);
        return rhs;
    }
        ...
        Periodicity const& periodicity)
    {
        ...
        add_soft_e_source_to_rhs(rhs, *mat.Cb[2], 2, periodicity, 1);
        return rhs;
    }
        ...
        Periodicity const& periodicity)
    {
        ...
        add_lumped_inductor_current_to_rhs(
            rhs, *mat.kappa[0], 0, periodicity);
        add_soft_e_source_to_rhs(rhs, *mat.Cb[0], 0, periodicity, 2);
        return rhs;
    }
        ...
        Periodicity const& periodicity)
    {
        ...
        add_lumped_inductor_current_to_rhs(
            rhs, *mat.kappa[1], 1, periodicity);
        add_soft_e_source_to_rhs(rhs, *mat.Cb[1], 1, periodicity, 2);
        return rhs;
    }
        ...
        Periodicity const& periodicity)
    {
        ...
        add_lumped_inductor_current_to_rhs(
            rhs, *mat.kappa[2], 2, periodicity);
        add_soft_e_source_to_rhs(rhs, *mat.Cb[2], 2, periodicity, 2);
        return rhs;
    }
